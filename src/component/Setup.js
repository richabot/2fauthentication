...
export default class Setup extends React.Component {
  ...
  setup() {
    fetch('http://localhost:4000/twofactor/setup', {method: "post"}).then( async response => {
  ...
  confirm(otp) {
    ...
    fetch('http://localhost:4000/twofactor/verify', {
        method: "post",
        headers: {
  ...
  /** disable 2fa */
  disable() {
    fetch('http://localhost:4000/twofactor/setup', {method: "delete"}).then(response => {
      const result = response.body;
  ...
  created() {
    fetch('http://localhost:4000/twofactor/setup', {method: "post"})
      .then(response => {
      const result = response.body;
